...
public class Main extends SimpleApplication {
    ...
    private final static Trigger moveLeft = new KeyTrigger(KeyInput.KEY_LEFT);
    private final static Trigger moveRight = new KeyTrigger(KeyInput.KEY_RIGHT);
    ...
    public void simpleInitApp() {
        inputManager.addMapping(MAPPING_MOVE_LEFT, moveLeft);
        inputManager.addMapping(MAPPING_MOVE_RIGHT, moveRight);
        
    
    private AnalogListener analogListener = new AnalogListener() {
        public void onAnalog(String name, float value, float tpf) {
            if(name.equals(MAPPING_MOVE_LEFT)){
    ...
    goldenBox1_Material.setTexture (

    "ColorMap", goldenBox1_Text);
    ...
    goldenBox2_geo.setLocalTranslation (
    2.32f, -2.3f, -2.3f);
    ...
    goldenBox2_Material.setTexture (

    "ColorMap", goldenBox2_Text);
    ...
    goldenBox3_geo.setLocalTranslation (
    0.0f, -2.3f, -5.65f);
    ...
    goldenBox3_Material.setTexture (

    "ColorMap", goldenBox3_Text);
    ...
    new Vector3f(-0.1f, -2f, -10.0f).normalizeLocal());
        rootNode.addLight (sun);
    AmbientLight al = new AmbientLight();

    al.setColor (ColorRGBA.White.mult
